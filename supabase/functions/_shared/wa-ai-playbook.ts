...
export const WA_AI_PLAYBOOK_SEM_REGISTRO: WaAiPlaybook = {
  ...
  fields: [
    ...
    },
    {
      ...
      ask: 'para quem você trabalhava',
      question: 'E você trabalhava para quem? Pode ser o nome da empresa ou da pessoa mesmo.',
    },
    {
      key: 'tipo_empregador', label: 'Tipo de empregador', type: 'enum',
      options: ['particular', 'publico'], required: true,
      ask: 'se era particular ou do governo',
      question: 'Esse serviço era particular mesmo, ou era para a prefeitura ou algum órgão do governo?',
    },
    {
      key: 'inicio', label: 'Início', type: 'data_mes_ano', required: true,
      ask: 'quando você começou',
      question: 'Você lembra quando começou lá? O mês e o ano já ajudam bastante.',
    },
    {
    ...
    },
    {
      ...
      ask: 'quando você saiu',
      question: 'E quando você saiu de lá? Mês e ano, se lembrar.',
      onlyWhen: { field: 'ainda_trabalha', value: 'não' },
    },
    {
      key: 'funcao', label: 'Função', type: 'texto', required: true,
      ask: 'o que você fazia lá',
      question: 'E o que você fazia lá no dia a dia?',
    },
    {
    ...
    },
    {
      ...
      ask: 'se eles chegaram a te pagar',
      question: 'E eles chegaram a te pagar, ou você trabalhou e não recebeu nada?',
    },
    {
      key: 'pagamento', label: 'Pagamento', type: 'texto', required: true,
      ask: 'quanto eles te pagavam',
      question: 'Quanto eles te pagavam, mais ou menos? Me diz também se era por dia, por semana ou por mês.',
    ...
    },
    {
      ...
      ask: 'se era fixo toda semana ou só de vez em quando',
      question: 'Era um serviço fixo, toda semana, ou só quando precisavam de você?',
    },
    {
      key: 'habitualidade', label: 'Rotina', type: 'texto', required: true,
      ask: 'quantos dias por semana e em que horário',
      question: 'Você ia quantos dias por semana, e mais ou menos de que horas até que horas?',
      onlyWhen: { field: 'trabalho_regular', value: 'regular' },
    },
    {
      key: 'subordinacao', label: 'Quem mandava', type: 'bool', required: true,
      ask: 'se alguém mandava no serviço',
      question: 'Tinha alguém mandando no serviço, falando o que fazer e cobrando de você?',
    },
    {
      key: 'tem_prova', label: 'Tem prova', type: 'bool', required: true,
      ask: 'se você guardou alguma coisa que mostre o trabalho',
      question: 'Você guardou alguma coisa que mostre que trabalhou lá? Serve Pix, conversa aqui do WhatsApp, foto, crachá, uniforme — qualquer coisinha ajuda.',
    },
    {
      key: 'provas', label: 'Quais provas', type: 'texto', required: true,
      ask: 'o que você tem guardado',
      question: 'O que você tem guardado?',
      onlyWhen: { field: 'tem_prova', value: 'sim' },
    },
    {
      key: 'tem_testemunha', label: 'Tem testemunha', type: 'bool', required: true,
      ask: 'se tem alguém que possa confirmar',
      question: 'E tem alguém que via você trabalhando lá e que poderia confirmar isso depois? Vizinho, colega, parente, qualquer um.',
    },
    {
      key: 'outros_trabalhos', label: 'Outro sem carteira', type: 'bool', required: true,
      ask: 'se teve outro trabalho sem carteira',
      question: 'Você teve algum outro trabalho sem carteira além desse?',
    },
    {
      key: 'envio_provas', label: 'Vai enviar as provas', type: 'bool', required: true,
      ask: 'se consegue mandar as provas por aqui',
      question: 'Você consegue me mandar essas coisas por aqui mesmo, pro advogado dar uma olhada?',
      onlyWhen: { field: 'tem_prova', value: 'sim' },
    },
    {
      key: 'aceita_honorarios', label: 'Aceitou honorários de 40%', type: 'bool', required: true,
      ask: 'se concorda com os 40% sobre o que receber',
      question: 'Uma última coisa, sobre o pagamento do escritório: a gente só recebe se você '
        + 'ganhar, e fica com 40% do que você receber no final, contando FGTS e '
        + 'seguro-desemprego. Tudo bem assim?',
    },
  ],
  stages: [
