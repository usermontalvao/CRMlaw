...
export const WA_AGENT_TOOLS_DISPLAY: WaToolDisplay[] = [
  ...
  { name: 'gerar_contrato', mention: '@GerarContrato', risk: 'alto', implemented: false,
    description: 'Preenche o contrato do escritório com os dados coletados.' },
  { name: 'enviar_link_assinatura', mention: '@EnviarAssinatura', risk: 'alto', implemented: false,
    description: 'Envia ao cliente o link para assinar o contrato.' },
  { name: 'marcar_reuniao', mention: '@MarcarReuniao', risk: 'alto', implemented: false,
    description: 'Agenda reunião do cliente com o escritório.' },
  { name: 'consultar_processo', mention: '@ConsultarProcesso', risk: 'baixo', implemented: false,
    description: 'Consulta o andamento dos processos do cliente.' },
];
